    ...
    <table class="table table-striped table-hover">
      ...
      <tbody>
        ...
        include 'config.php';
                ...
                $sql = "SELECT CHILDRENID , CHILDREN_NAME, CHILDREN_DATEOFBIRTH , c.PARENTID, PARENT_NAME FROM children c inner join parent p ON c.PARENTID = p.PARENTID where c.PARENTID = p.PARENTID";
